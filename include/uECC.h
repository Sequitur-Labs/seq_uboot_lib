...
#define uECC_SUPPORTS_secp256k1 0 // k1 worked
//#define uECC_SUPPORTS_secp256r1 0  // is this the same as prime256v1
...
*/
int uECC_make_key(unsigned char *public_key, unsigned char *private_key, uECC_Curve curve);
...
*/
int uECC_shared_secret(const unsigned char *public_key,
...
*/
void uECC_compress(const unsigned char *public_key, unsigned char *compressed, uECC_Curve curve);
...
*/
void uECC_decompress(const unsigned char *compressed, unsigned char *public_key, uECC_Curve curve);
...
*/
int uECC_valid_public_key(const unsigned char *public_key, uECC_Curve curve);
...
*/
int uECC_compute_public_key(const unsigned char *private_key, unsigned char *public_key, uECC_Curve curve);
...
*/
int uECC_sign(const unsigned char *private_key,
...
typedef struct uECC_HashContext {
    ...
    void (*update_hash)(const struct uECC_HashContext *context,
                        ...
                        unsigned message_size);
    void (*finish_hash)(const struct uECC_HashContext *context, unsigned char *hash_result);
...
Returns 1 if the signature generated successfully, 0 if an error occurred.
*/
int uECC_sign_deterministic(const unsigned char *private_key,
                            const unsigned char *message_hash,
                            unsigned hash_size,
...
*/
int uECC_verify(const unsigned char *public_key,
                const unsigned char *message_hash,
                unsigned hash_size,
